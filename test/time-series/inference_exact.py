"""
Perform MCMC-Exact on time series example.
...
- InferenceData output of MCMC-Exact
  @ '../../data/time-series/psize{pool_size}_m{n_markers}_id{ds_idx}_exact.netcdf'
- Posterior predictive samples as a numpy.darray of dimensions (chains*N) x H
  @ '../../data/time-series/psize{pool_size}_m{n_markers}_id{ds_idx}_exact_pred_samples.npy'
- Summary statistics of posterior predictive distribution as a dictionary
  @ '../../data/time-series/psize{pool_size}_m{n_markers}_id{ds_idx}_exact_sumstats.pkl'
"""
...
t = time()
with model:
    idata = hier_latent_mult_mcmc(ps, lm_list, H, n_sample, n_burnin, ['exact']*N, jaxify=False, 
...
np.save(f'../../data/time-series/psize50_m3_exact_pred_samples.npy', pred_samples)
# np.save('../../data/time-series/psize50_m3_exact_pred_samples_tint.npy', pred_samples[:,::100])
...
with open(f'../../data/time-series/psize50_m3_exact_sumstats.pkl', 'wb') as fp:
