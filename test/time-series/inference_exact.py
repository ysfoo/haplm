...
t = time()
with model:
    idata = hier_latent_mult_mcmc(ps, lm_list, H, draws, tune, ['exact']*N,
                                  jaxify=False, chains=chains, seed=2023, postprocessing_chunks=25)
mcmc_time = time() - t
...
np.save('../../data/time-series/psize50_m3_exact_pred_samples_tint.npy',
pred_samples[:,::100])
